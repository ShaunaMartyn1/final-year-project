...
from decouple import config #secret+key

# Build paths inside the project like this: BASE_DIR / 'subdir'.
BASE_DIR = Path(__file__).resolve().parent.parent

AUTH_USER_MODEL = "core.User" #check if this is the right place for this 
SITE_ID = 1
...
#SECRET_KEY = "django-insecure-^k#36&qk(ptpszx6kg(&6myidd*@5pxy9lp__@6$2sycdrs)k%"
...
INSTALLED_APPS = [
    ...
    'dj_rest_auth',
    #allauth - all of these from django rest auth documentation
    'allauth',
    'allauth.account',
...
#password: november! username:shauna email:shauna@g/email.com
#"key": "5c48c41d4cabf1397b942ceb878822f856b620a0" shauna12 + gmail12 november!


EMAIL_HOST = 'smtp.gmail.com'
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = config("EMAIL_HOST_USER")#senders email - Backend
